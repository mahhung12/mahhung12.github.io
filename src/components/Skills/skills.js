...
import { sqlIcon } from "../../assets/images/sql-server.svg";
import { SQLFile } from "../../assets/images/sql-file.svg";
...
function Skills() {
    ...
    return (
        <div className="Skills-Wrapper">
            <div className="title">{t("section-skills.title")}</div>
            <div className="section-skills">
                ...
                <div className="skill">
                    ...
                    <div className="skill-sideName">
                        {t("section-skills.Skill1-title")}
                    </div>
                    <div className="lists-skill">
                        <div className="lists-skill__item">
                            ...
                            <div className="item-name">HTML 5</div>
                        </div>
                        <div className="lists-skill__item">
                            <div className="item-img">
                                <svg
                            ...
                            <div className="item-name">CSS 3</div>
                        </div>
                        <div className="lists-skill__item">
                            <div className="item-img">
                                <svg
                        ...
                        <div className="lists-skill__item">
                            ...
                            <div className="item-name">ReactJS</div>
                        </div>
                        <div className="lists-skill__item">
                            <div className="item-img">
                                <svg
                            ...
                            <div className="item-name">SASS</div>
                        </div>
                        <div className="lists-skill__item">
                            <div className="item-img">
                                <svg
                            ...
                            <div className="item-name">Boostrap</div>
                        </div>
                    </div>
                    ...
                    <div className="lists-skill">
                        ...
                        <div className="lists-skill__item">
                            <div className="item-img">
                                ...
                                {/* <img
                                    // src={sqlIcon}
                                    src="https://img.icons8.com/dotty/80/000000/sql.png"
                                    alt="SQL Server"
                                    srcSet=""
                                /> */}
                            </div>
                            <div className="item-name">MySQL/MSSQL</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="skill">
                    ...
                    <div className="lists-skill">
                        <div className="lists-skill__item">
                            ...
                            <div className="item-name">English</div>
                        </div>
                        <div className="lists-skill__item">
                            <div className="item-img">
                                <svg
                        ...
                        <div className="lists-skill__item">
                            ...
                            <div className="item-name">Optimizations</div>
                        </div>
                    </div>
                </div>
            </div>
